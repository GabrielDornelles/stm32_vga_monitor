...
TARGET_F = 35156.25   # In Hz so 50.0 is 0.020 seconds period and 0.25 is 4 seconds period
CLOCK_MCU = 72000000
TOLERANCE = 0.0001
...
output = prettify(df,row_limit=50,col_limit=50,delay_time=0.1)
print(output)
print(f'These are the [green]{df.shape[0]}[/green] total combination meeting your [orchid1]{TOLERANCE}[/orchid1] tolerance requirement')
